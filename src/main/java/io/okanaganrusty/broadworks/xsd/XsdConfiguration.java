...
public class XsdConfiguration {
	...
	public Jaxb2Marshaller xsdMarshaller() {
		...
		xsdMarshaller.setClassesToBeBound(new Class[] { 
				...
				com.broadsoft.broadworks.schema.OCICommand.class, com.broadsoft.broadworks.schema.OCIDataResponse.class,
				com.broadsoft.broadworks.schema.OCIMessage.class, com.broadsoft.broadworks.schema.OCIRequest.class,
				com.broadsoft.broadworks.schema.OCIResponse.class, com.broadsoft.broadworks.schema.OCITable.class,
